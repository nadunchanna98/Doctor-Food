        ...
        <View style={styles.container}>
          ...
          <View style={styles.detailsContainer}>
            ...
            <View style={styles.detail}>
              ...
              {blood ? <Text style={styles.detailText}>Blood Group : {blood}</Text> : <Text style={{
                fontSize: width * 0.042,
                paddingLeft: width * 0.06,
                fontWeight: "bold"
              }}>Add your blood group !!</Text>}
            </View>
            <View style={styles.detail}>
            ...
            <View style={styles.detail}>
              ...
              {dob ? <Text style={styles.detailText}>Description : {Allergies[0]}</Text> : <Text style={{
                fontSize: width * 0.042,
                paddingLeft: width * 0.06,
                fontWeight: "bold"
              }}>Add your Allergies and details !!</Text>}
            </View>
          </View>
          ...
          <Modal visible={visible} animationType="slide" onRequestClose={hide}>
            <ScrollView showsVerticalScrollIndicator={false}>
              <View style={styles.modalContainer}>
                ...
                <Formik
                  initialValues={{ name: name, email: email , dob: dob, blood: blood, Allergies: Allergies     }}
                    ...
                    return (
                      <View>
                        <View style={styles.inputContainer}>
                          ...
                          <View>
                            <Text style={styles.textInputTitle}>Blood Group</Text>
                            <TextInput style={styles.input} value={values.blood} placeholder="Ex: O+" />
                          </View>
                          <View>
                          ...
                          <View>
                            <Text style={styles.textInputTitle}>Allergies</Text>
                            <TextInput style={styles.input} value={values.Allergies} placeholder="Ex: Allergies" />
                          </View>
                        </View>
